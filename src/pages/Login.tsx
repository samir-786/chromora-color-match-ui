...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#ffe5e5] to-white flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600">Sign in to your Chromora account</p>
          </CardHeader>
          <CardContent>
